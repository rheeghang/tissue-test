...
const Page4 = () => {
  const { title, artist, caption, body } = koData.page4;
  const targetAlpha = 255; // 각도만 지정
  const { blurAmount, currentAlpha, tolerance } = useBlurEffect(targetAlpha); // 기본 설정 사용
  ...
  return (
    <div className="min-h-screen bg-black fixed w-full">
      <div className="outer-container rotate-[255deg] top-[-30vh] relative w-[95%] h-[150vh] items-center justify-center"
        style={{
      ...
      >
        ...
        >
          <div 
            className='container p-5 mt-[65vh] bg-page4-bg text-page4-text text-stroke-white-thin mb-[100vh] relative w-[100%]'
          >
