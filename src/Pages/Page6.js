...
const Page6 = () => {
  const { title, artist, caption, body } = koData.page6;
  const targetAlpha = 190;  // 135도 회전
  ...
  return (
    <div className="min-h-screen bg-black fixed w-full">
      <div className="outer-container br-white rotate-[190deg] top-[-30vh] relative w-[95%] h-[150vh] items-center justify-center"
        style={{
      ...
      >
        ...
        >
          <div 
            className='container p-8 mt-[45vh] bg-page6-bg text-page6-text text-stroke-thin mb-[100vh] relative w-[100%]'
          >
